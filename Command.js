...
/**
 * Constructor
 * @param {string} commandName - The name of the command, as in "<commandName> paramName1 paramValue1 ..."
 * @constructor
 */
 ...
 */
Command.prototype.addParameter = addParameter;
/**
 ...
 */
Command.prototype.getParameter = getParameter;
/**
 ...
 */
Command.prototype.validate = validate;
 ...
 */
Command.prototype.willParseCommand = isValidCommand;

/**
 * Gets the model of the command. Will be empty if the command has not
 * been parsed.
 */
Command.prototype.getModel = function () {
  return this.model;
};
/**
 * Sets the model for this command. Empty by default.
 * @param {object} modelObject - A simple object
 */
Command.prototype.setModel = function (modelObject) {
